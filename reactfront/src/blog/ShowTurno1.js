...
export const ShowTurno1 = ({ data }) => {
  
  const totalVentaturno = data.reduce(
    (total, data) => total + data.totalventa,
    0
  );
        ...
        <div className="col">
          <div className="card">
            <div className="card-body custom-card">
              <div className="row">
                <div className="col">
                  <h5 className="card-title">Ganancias TURNO 1</h5>
                  <p className="card-text">${totalVentaturno}</p>
                </div>
                <div className="col">
                  <h5 className="card-title">Boletos TURNO 1</h5>
                  ...
                  <div className="row">
                    <div className="col">
                      <p className="card-text">
                        {" "}
                        Ganancias: ${totalVentaVendedora}
                      </p>
                    </div>
                    <div className="col">
                      <p className="card-text">
                        {" "}
                        Boletos: {totalBoletosVendedora}
                      </p>
                    </div>
                  </div>
                </div>
